...
ANIMALS_URL  = "http://bovin.atwebpages.com/api/animaux_eleveur.php"
...
.eleveur-card {
    background: #f9fdf6; border: 1px solid #c8e6c9;
    border-radius: 12px; padding: 14px 18px; margin-bottom: 10px;
}
.eleveur-header { display: flex; align-items: center; gap: 12px; margin-bottom: 6px; }
.eleveur-avatar {
...
.badge-count {
    ...
    border: 1px solid #a5d6a7; border-radius: 20px; padding: 2px 10px;
...
if not eleveurs:
    ...
    for elev in eleveurs:
        ...
        with st.expander(f"👤 {full_name}   —   {nb_animaux} {T['animals_of']}", expanded=False):
            ...
            if not animaux:
                ...
                for a in animaux:
                    statut_raw = (
                        a.get("statut_sante") or a.get("statut") or a.get("etat_sante") or "normal"
                    ).lower()
                    rows.append({
                        T["col_a_nom"]    : a.get("nom") or a.get("nom_animal") or a.get("name") or f"#{a.get('id','?')}",
                        T["col_a_race"]   : a.get("race") or a.get("breed") or "—",
                        T["col_a_sexe"]   : a.get("sexe") or a.get("sex") or "—",
                        T["col_a_nais"]   : a.get("date_naissance") or a.get("naissance") or a.get("birthdate") or "—",
                        T["col_a_temp"]   : a.get("temperature") or a.get("temp") or "—",
                        T["col_a_activ"]  : a.get("niveau_activite") or a.get("activite") or "—",
